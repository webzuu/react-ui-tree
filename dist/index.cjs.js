...
function (_Component) {
  ...
  function UITree(_props) {
    ...
    _this.drag = function (e) {
      if (_this._start) {
        var startIndex = _this.state.tree.getIndex(_this.dragging.id);

        var startParent = _this.state.tree.getIndex(startIndex.parent);
    ...
    _this.toggleCollapse = function (nodeId) {
      ...
      if (node.collapsed && _this.props.onCollapse) {
        _this.props.onCollapse(node);
      }

      if (!node.collapsed && _this.props.onExpand) {
        _this.props.onExpand(node);
      }
